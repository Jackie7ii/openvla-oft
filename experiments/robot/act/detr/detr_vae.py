...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, action_dim, qpos_dim, num_queries, camera_names):
        ...
        Parameters:
            ...
            qpos_dim: dimension of the joint position space
...
class CNNMLP(nn.Module):
    def __init__(self, backbones, action_dim, qpos_dim, camera_names):
        ...
        Parameters:
            ...
            qpos_dim: joint position dimension of the robot
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         DETR can detect in a single image. For COCO, we recommend 100 queries.
            aux_loss: True if auxiliary decoding losses (loss at each decoder layer) are to be used.
        """
    ...
    def forward(self, qpos, image, env_state, actions=None):
        ...
        features = torch.cat([flattened_features, qpos], axis=1) # qpos: qpos_dim each
...
def build(args):
    ...
    qpos_dim = args.qpos_dim # TODO hardcode
